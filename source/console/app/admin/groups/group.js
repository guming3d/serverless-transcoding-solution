...
angular.module('serverlessVideoTranscode.admin.group', ['serverlessVideoTranscode.main', 'serverlessVideoTranscode.utils', 'serverlessVideoTranscode.factory.admin'])
    ...
    var getGroupDetails = function() {
        ...
        adminGroupFactory.getGroup($stateParams.group_name, function(err, group) {
            ...
            if (group.UserList.length > 0) {
                $scope.subtitle = 'Manage the Serverless Video Transcode group by updating user list and description.';
            } else {
                $scope.subtitle = 'Manage the Serverless Video Transcode group by updating description.';
            }
