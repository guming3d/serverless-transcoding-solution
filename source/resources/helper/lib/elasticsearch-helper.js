...
/**
 * Helper function to interact with the Serverless Video Transcode Elasticsearch Service cluster for Serverless Video Transcode cfn custom resource.
 *
...
let elasticsearchHelper = (function() {
    ...
    /**
     * Creates a new search index in the Serverless Video Transcode Elasticsearch Service cluster.
     * @param {string} clusterUrl - URL for the Serverless Video Transcode Elasticsearch Service cluster.
    ...
    elasticsearchHelper.prototype.createSearchIndex = function(clusterUrl, searchIndex, cb) {
        ...
        client.indices.create({
            ...
            if (err) {
                console.log('The Serverless Video Transcode elasticsearch cluster is down!');
                console.log(err);
                return cb(err, null);
            } else {
                console.log(resp);
