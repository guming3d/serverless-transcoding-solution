        ...
        var params = {
            ...
            AdminCreateUserConfig: {
                ...
                InviteMessageTemplate: {
                    EmailMessage: [
                        'You are invited to join the Serverless Video Transcode. Your Serverless Video Transcode username is {username} and temporary password is {####}. \n \n Please sign in to the Serverless Video Transcode with your email address and your temporary password at',
                        appUrl, '.'
                    ].join(' '),
                    EmailSubject: 'Your Serverless Video Transcode account.',
