...
let s3Helper = (function() {
    ...
    /**
     * Configure Serverless Video Transcode S3 buckets
     *
            ...
            s3.putBucketCors(paramsCors, function(err, data) {
                ...
                createBucket(websiteBucket, function(err, data) {
                    ...
                    s3.putBucketWebsite(paramsBucketWebsite, function(err, data) {
                        ...
                        return cb(null, {code: 200, message: `Serverless Video Transcode buckets created.`});
                    });
                });
            });
        });
    ...
    /**
     * Configure Serverless Video Transcode website buckets policy
     *
     * @param {string} websiteBucket - Serverless Video Transcode website bucket name.
    ...
    /**
     * Process delete event for Serverless Video Transcode S3 buckets.
     *
     * @param {string} defaultBucket - Serverless Video Transcode main bucket name.
     * @param {string} websiteBucket - Serverless Video Transcode website bucket name.
    ...
    s3Helper.prototype.createAppVariables = function(userPoolId, userPoolClientId, apigEndpoint, appVersion, destS3Bucket, federatedLogin, loginUrl, logoutUrl, uuid, cb) {
        var _content = [
        ...
        s3.putObject(params, function(err, data) {
            if (err) {
                console.log(err);
                return cb('error creating app-variables.js file for Serverless Video Transcode website', null);
            }
    ...
    /**
     * Helper function to download the Serverless Video Transcode website archive to local storage for processing.
