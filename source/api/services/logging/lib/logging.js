                ...
                if (err.code === 'ResourceNotFoundException' && err.message ===
                    ...
                    createAccessLogGroup(function(err, data) {
                        if (err) {
                            return cb(null, {
                                error: {
                                    message: 'Unable to create a Serverless Video Transcode access log group'
                                }
                            });
                        }
                        ...
                        createAccessLogStream(function(err, data) {
                            if (err) {
                                return cb(null, {
                                    error: {
                                        message: 'Unable to create a Serverless Video Transcode access log stream for today.'
                                    }
                                });
                            }
