...
/**
 * Performs CRUD operations for Serverless Video Transcode users interfacing primiarly with the Serverless Video Transcode
...
let user = (function() {
    ...
    /**
     * Retrieves Serverless Video Transcode users from Amazon Cognito user pool .
    ...
    /**
     * Disables a user account in the Serverless Video Transcode Amazon Cognito user pool.
    ...
    /**
     * Enables a user account in the Serverless Video Transcode Amazon Cognito user pool.
    ...
    /**
     * Deletes a user account from the Serverless Video Transcode Amazon Cognito user pool.
    ...
    /**
     * Update the role for a user account in the Serverless Video Transcode Amazon Cognito user pool.
    ...
    /**
     * Creates a user account in Serverless Video Transcode Amazon Cognito user pool and send invitation to user.
    ...
    /**
     * Retrieves a user account from the Serverless Video Transcode Amazon Cognito user pool.
