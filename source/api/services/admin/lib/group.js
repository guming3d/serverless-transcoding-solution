...
/**
 * Performs CRUD operations for Serverless Video Transcode groups interfacing primiarly with the Serverless Video Transcode
...
let group = (function() {
    ...
    /**
     * Retrieves Serverless Video Transcode groups from Amazon Cognito group pool .
    ...
    /**
     * Creates a new group in the Serverless Video Transcode Amazon Cognito user pool.
     *
    ...
    /**
     * Retrieves a group from the Serverless Video Transcode Amazon Cognito user pool.
     *
    ...
    /**
     * Deletes the specified group from the Serverless Video Transcode Amazon Cognito user pool.
