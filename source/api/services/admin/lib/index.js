...
function processRequest(event, ticket, cb) {
    ...
    if (event.resource === '/admin/groups' && event.httpMethod === 'GET') {
        ...
        let _body = JSON.parse(event.body);
        _operation = ['Update Serverless Video Transcode group', groupName, _body.action].join(' ');
        ...
        let groupName = decodeURI(event.pathParameters.group_name);
        _operation = ['retrieve Serverless Video Transcode group', groupName].join(' ');
        ...
        let groupName = decodeURI(event.pathParameters.group_name);
        _operation = ['delete Serverless Video Transcode group', groupName].join(' ');
        ...
        _operation = 'list Serverless Video Transcode users';
        ...
        event.pathParameters.user_id = decodeURI(event.pathParameters.user_id);
        _operation = ['retrieve Serverless Video Transcode user', event.pathParameters.user_id].join(' ');
        ...
        event.pathParameters.user_id = decodeURI(event.pathParameters.user_id);
        _operation = ['delete Serverless Video Transcode user', event.pathParameters.user_id].join(' ');
        ...
        if (_body.operation === 'update') {
            _operation = ['update Serverless Video Transcode user', event.pathParameters.user_id].join(' ');
            ...
            event.pathParameters.user_id = decodeURI(event.pathParameters.user_id);
            _operation = ['disable Serverless Video Transcode user', event.pathParameters.user_id].join(' ');
            ...
            event.pathParameters.user_id = decodeURI(event.pathParameters.user_id);
            _operation = ['enable Serverless Video Transcode user', event.pathParameters.user_id].join(' ');
        ...
        _operation = 'list Serverless Video Transcode configuration settings';
        ...
        _operation = 'update Serverless Video Transcode configuration settings';
        ...
        _operation = 'retrieve Serverless Video Transcode governance settings';
        ...
        _operation = ['retrieve Serverless Video Transcode governance setting', event.pathParameters.setting_id].join(' ');
        ...
        _operation = ['delete Serverless Video Transcode governance setting', event.pathParameters.setting_id].join(' ');
        ...
        _operation = ['update Serverless Video Transcode governance setting', event.pathParameters.setting_id].join(' ');
