...
/**
 * Performs authorization function for Serverless Video Transcode to determine if a user [via UI or API/CLI] has the access
...
let auth = (function() {
     ...
     * deconstruction of JWT from the Serverless Video Transcode Amazon Cognito user pool
     ...
     * is from the Serverless Video Transcode GUI represented by the Amazon Cognito JWT provided by an authenticated
     * user
     * @param {Object} pems - JWKs from the Serverless Video Transcode Amazon Cognito user pool in PEM format.
     * @param {JSON} event - Request event.
     * @param {array} authorizedRoles - Roles authorized to perform the requested operation.
     ...
     * Validates the user represented in the request Auth header token has the
     * appropriate role to perform the requested operation. The token processed by this function
     * is a native Serverless Video Transcode API call represented by an access key and secret access key
     * @param {JSON} event - Request event.
     * @param {array} authorizedRoles - Roles authorized to perform the requested operation.
    ...
    /**
     * Retrieves a user from the Serverless Video Transcode Amazon Cognito user pool and validates that thier assigned
     ...
     * the Serverless Video Transcode Version 4 signature and comparing against the signature recieved from the client.
     * @param {JSON} requestKeys - Represents the access key and Serverless Video Transcode Version 4 signature sent in request.
     * @param {array} authorizedRoles - Roles authorized to perform the requested operation.
     * @param {string} username - Username of Amazon Cognito user to check role.
     * @param {JSON} ticket - Serverless Video Transcode authorization ticket.
    ...
    /**
     * Reconstructs the Serverless Video Transcode Version 4 signature and compares it against the signature
     * recieved from the client.
     * @param {string} sig - Serverless Video Transcode Version 4 signature sent in request.
    ...
    /**
     * Helper function to retrieve user account from the Serverless Video Transcode Amazon Cognito user pool.
     * @param {string} userid - Username of the user to retr from the Serverless Video Transcode Amazon Cognito user pool.
