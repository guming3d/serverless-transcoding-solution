...
let manifest = (function() {
    ...
    /**
     * Process an import manifest file uploaded to a Serverless Video Transcode package for bulk
     ...
     * @param {string} defaultBucket - Serverless Video Transcode default Amazon S3 bucket to post "cart" manifest files.
     ...
     * to a pacakge after validating the object is accessible to the Serverless Video Transcode.
     * @param {JSON} event - Request event.
     ...
     * to the Serverless Video Transcode package.
