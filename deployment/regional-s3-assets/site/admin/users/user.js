...
angular.module('serverlessVideoTranscode.admin.user', ['serverlessVideoTranscode.main', 'serverlessVideoTranscode.utils', 'serverlessVideoTranscode.factory.admin'])
...
.controller('AdminUserCtrl', function($scope, $state, $stateParams, $blockUI, $q, adminUserFactory, adminApiKeysFactory, adminGroupFactory) {
    ...
    var getUserDetails = function() {
        ...
        .then(values => {
            ...
            $scope.subtitle = 'Manage the Serverless Video Transcode user by enabling, disabling and set the user\'s role.';
